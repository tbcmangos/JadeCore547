...
void AchievementMgr<T>::SendAchievementEarned(AchievementEntry const* achievement) const
{
    ...
    {
        UwowCore::AchievementChatBuilder say_builder(*GetOwner(), CHAT_MSG_GUILD_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        UwowCore::LocalizedPacketDo<UwowCore::AchievementChatBuilder> say_do(say_builder);
    ...
    {
        CellCoord p = UwowCore::ComputeCellCoord(GetOwner()->GetPositionX(), GetOwner()->GetPositionY());

        Cell cell(p);
        cell.SetNoCreate();

        UwowCore::AchievementChatBuilder say_builder(*GetOwner(), CHAT_MSG_ACHIEVEMENT, LANG_ACHIEVEMENT_EARNED, achievement->ID);
        UwowCore::LocalizedPacketDo<UwowCore::AchievementChatBuilder> say_do(say_builder);
        UwowCore::PlayerDistWorker<UwowCore::LocalizedPacketDo<UwowCore::AchievementChatBuilder> > say_worker(GetOwner(), sWorld->getFloatConfig(CONFIG_LISTEN_RANGE_SAY), say_do);
        TypeContainerVisitor<UwowCore::PlayerDistWorker<UwowCore::LocalizedPacketDo<UwowCore::AchievementChatBuilder> >, WorldTypeMapContainer > message(say_worker);
