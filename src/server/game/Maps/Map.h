...
class InstanceMap;
class Transport;
namespace UwowCore { struct ObjectUpdater; }
...
class Map : public GridRefManager<NGridType>
{
    ...
    public:
        ...
        void VisitNearbyCellsOf(WorldObject* obj, TypeContainerVisitor<UwowCore::ObjectUpdater, GridTypeMapContainer> &gridVisitor, TypeContainerVisitor<UwowCore::ObjectUpdater, WorldTypeMapContainer> &worldVisitor);
        ...
        {
            return IsGridLoaded(UwowCore::ComputeGridCoord(x, y));
        }
