...
public:
    ...
    struct boss_sartharionAI : public ScriptedAI
    {
        ...
        void CastLavaStrikeOnTarget(Unit* target)
        {
            ...
            UwowCore::AllCreaturesOfEntryInRange checker(me, NPC_FIRE_CYCLONE, 200.0f);
            UwowCore::CreatureListSearcher<UwowCore::AllCreaturesOfEntryInRange> searcher(me, pFireCyclonesList, checker);
