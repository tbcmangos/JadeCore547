...
public:
    ...
    static bool HandleMmapTestArea(ChatHandler* handler, char const* /*args*/)
    {
        ...
        CellCoord pair(UwowCore::ComputeCellCoord(object->GetPositionX(), object->GetPositionY()));
        Cell cell(pair);
        cell.SetNoCreate();

        std::list<Creature*> creatureList;

        UwowCore::AnyUnitInObjectRangeCheck go_check(object, radius);
        UwowCore::CreatureListSearcher<UwowCore::AnyUnitInObjectRangeCheck> go_search(object, creatureList, go_check);
        TypeContainerVisitor<UwowCore::CreatureListSearcher<UwowCore::AnyUnitInObjectRangeCheck>, GridTypeMapContainer> go_visit(go_search);
